...
```sql
MariaDB [aanchal_2cse12]> SELECT E.*
    -> FROM EMPLOYEE E
...
MMariaDB [aanchal_2cse12]> SELECT ENAME
    -> FROM EMPLOYEE
    -> WHERE JOB <> 'MANAGER'
...
MariaDB [aanchal_2cse12]> SELECT E.ENAME
    -> FROM EMPLOYEE E
...
MariaDB [aanchal_2cse12]> SELECT E.ENAME, D.DNAME, E.SAL, E.COMM
    -> FROM EMPLOYEE E
    -> JOIN DEPARTMENT D ON E.DEPTNO = D.DEPTNO
...
```sql
MariaDB [aanchal_2cse12]> SELECT E.ENAME, S.GRADE
    -> FROM EMPLOYEE E
    -> JOIN SALGRADE S ON E.SAL BETWEEN S.LOSAL AND S.HISAL
